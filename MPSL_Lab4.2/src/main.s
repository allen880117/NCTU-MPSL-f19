...
.data
	...
	student_id: .byte 0, 6, 1, 6, 3, 0, 9 //TODO: put your student id
...
DisplayStudentID:
	...
	ldr  r0, =#0x07 // r0(ADDR) = 0x07(DIGIT_6)

	DisplayStudentID_Loop:
		ldrb r1, [r9, r2]  // r1(DATA) = arr[r2]
		BL   max7219_send

		sub  r0, r0, #1 // next Digit (Uppest to Lowest)
		add  r2, r2, #1
		cmp  r2, #7
		bne  DisplayStudentID_Loop
...
max7219_init:
	...
	ldr  r0, =#DECODE_MODE
	ldr  r1, =#0x7F // No Decode for digit 7
	BL   max7219_send
	...
	ldr  r0, =#SCAN_LIMIT
	ldr  r1, =#0x6 // The Digits allowed to display, 0 means 1 digit, 1 means 2 digits
	BL   max7219_send
